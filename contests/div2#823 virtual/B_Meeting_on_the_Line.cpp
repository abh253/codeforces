...
void solve(){
    ...
    sort(all(v));
    // double tmin=v[n-1][0]-v[0][0];
    // double x0=
    // FOR(i,n-1){
    //     double l=v[i][0];
    //     double r=v[i+1][0];

    //     ll eleleft=i+1,eleright=n-eleleft;
    //     ll diff=r-l;
    ...
    //         // mid/=1000000.0;
    //         double mm=mid/1000000.0;
    //         if(mm-v[0][0]>v[n-1][0]-mm){
    //             r=mid;
    //         }else if(mm-v[0][0]<v[n-1][0]-mm){
    //             l=mid;
    //         }else{
    //             break;
    //         }
