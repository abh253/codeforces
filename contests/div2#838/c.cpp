...
// ll solve2(int zerocnt,int onecnt,int i,string &s){
//     if(i==s.length())return 0;
//     if(mp.count({zerocnt,onecnt})){
//         return mp[{zerocnt,onecnt}];
//     }
...
//         zerocnt++;
//         if(zerocnt>onecnt){
//             return 2+solve2(zerocnt+1,onecnt,i+1,s)+solve2(zerocnt,onecnt+1,i+1,s);
//         }else{
//             return 1+solve2(zerocnt+1,onecnt,i+1,s);
//         }
//     }else {onecnt++;
//          if(onecnt>zerocnt){
//             return 2+solve2(zerocnt,onecnt+1,i+1,s)+solve2(zerocnt+1,onecnt,i+1,s);
//         }else{
//             return 1+solve2(zerocnt,onecnt+1,i+1,s);
//         }
...
void solve(){
    ...
    for(int i=0;i<n;i++){
        if(s[i]=='0'){
            zerocnt++;
            onecnt=0;
            ans+=power(2,zerocnt-1,mod2);
        }else{
            onecnt++;
            zerocnt=0;
            ans+=power(2,onecnt-1,mod2);
        }
        ans%=mod2;
    }
