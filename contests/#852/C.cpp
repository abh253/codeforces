...
void solve(){
    ...
    vll mx(n);
    vll mn(n);
    FOR(i,n)mx[i]=i+1,mn[i]=n-i;
    // errA(mx);
    // errA(mn);
    ll l=0,r=n-1;
    while(l<r and (v[l]==mn.back() or v[l]==mx.back() or v[r]==mn.back() or v[r]==mx.back())){

        while(l<r and (v[l]==mx.back() or v[l]==mn.back())){
            if(v[l]==mn.back()){
                mn.pop_back();
            }else mx.pop_back();
            l++;
        ...
        while(r>l and (v[r]==mx.back() or v[r]==mn.back())){
            if(v[r]==mx.back()){
                mx.pop_back();
            }else mn.pop_back();
            r--;
