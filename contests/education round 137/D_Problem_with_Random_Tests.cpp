...
//     }
// }
// as i know first string is complete string
// and for second string i can take a string which is right shifted of whole
// and i can only right shift such such that first 0 bit should become one
// and i will try to find maximum ans from that
