...
void solve(){
    ...
    For(i,1,n-1){
        dp[i][0]=min(zoro[i-1][1]*zoro[i][0]+dp[i-1][0],zoro[i-1][0]*zoro[i][0]+dp[i-1][1]);
        dp[i][1]=min(zoro[i-1][1]*zoro[i][1]+dp[i-1][0],zoro[i-1][0]*zoro[i][1]+dp[i-1][1]);
        // err2(zoro[i][0],zoro[i][1]);
    }
