...
// i will do total possible -unambiguos
// for an array to be unambiguas it should have
// b=[1,1,1,1,1,1,1..]
// that means we can put an element from 1 to m at a position which for the gcd with current and lower indext wont give 1 (except 1st indes);
