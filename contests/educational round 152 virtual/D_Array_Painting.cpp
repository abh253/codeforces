...
void solve(){
    ...
    ll n;cin>>n;
    vll v(n);vinput(v);
    // at least 1 coint will be used 
    // if there is a index 'i' such that v[i+1] and v[i-1] is zero then use one coin to make it red
    // 01111011101110 -> in this patter every island of 1 need to use 1 coin is a 1
    // 011222011201120 -> in this patter similar logic is applies and if 2 is present then it will make both the 0's red, the 0 which is preceding island and the zero which is succeding island
