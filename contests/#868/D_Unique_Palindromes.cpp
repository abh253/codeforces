...
// observations
// with increase in size the number of palandromic substrins
// with increase in size one 
// palindromes can increase maximum by 1;
// for any length i there can be max i unique palindrome and min palindromes can be min(size,3);
