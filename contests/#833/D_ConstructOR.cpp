...
void solve(){
    ...
    ll numLsb=least_s_bit(num,30);  
    ll dLsb=least_s_bit(d,30);
    if(numLsb<dLsb){
        mone;
        return;
...
// a|x and b|x is divisible by d
// here or opration taking place that means on-bits will only increase
// 