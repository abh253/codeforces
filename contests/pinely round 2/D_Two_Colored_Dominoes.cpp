...
void solve(){
    ...
    // first put a convention and if we can't hold that convention then output -1 otherwise a valid color pattern

    // blacks and white is each row and column should be equal


    // basically we need even number of dominoes vertically in a row and even number
    // even number of horizontal dominos
    // if thats not the case then there is no solution
