...
// bool comp(const vll &a,ll &key){
//     return a[0]<key;
// }
ll upperbound(vector<vll>&quer,ll x){
    ll l=0,r=quer.size()-1;
    while(l<r){
        ll mid=(l+r)/2;
    ...
    if(quer[l][0]<=x)return quer.size();
    return l;
}
void solve(){
