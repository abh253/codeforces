...
void solve(){
    ...
    vinput(v);
    for(int i=0;i<3;i++){
        if(v[i][0]!='.' and v[i][0]==v[i][1] and v[i][1]==v[i][2]){
            cout<<v[i][0]<<endl;
            return;
        }
    }
    for(int i=0;i<3;i++){
        if(v[0][i]!='.' and v[0][i]==v[1][i] and v[1][i]==v[2][i]){
            cout<<v[0][i]<<endl;
            return;
        }
    }
    if(v[0][0]!='.' and v[0][0]==v[1][1] and v[1][1]==v[2][2]){
        cout<<v[0][0]<<endl;
        return;
    }
    if(v[2][0]!='.' and v[2][0]==v[1][1] and v[1][1]==v[0][2]){
        cout<<v[1][1]<<endl;
        return;
    }
    cout<<"DRAW"<<endl;
