...
int krdoyar(ll i,ll h,vll &v,ll g,ll b){
    if(i==v.size())return 0;
    if(v[i]<h){
        return 1+krdoyar(i+1,h+v[i]/2,v,g,b);
    }

    ll ans1=g>0?krdoyar(i,h*2,v,g-1,b):0;
    ll ans2=b>0?krdoyar(i,h*3,v,g,b-1):0;
