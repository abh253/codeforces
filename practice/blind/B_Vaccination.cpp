...
// patient can move form ti to ti+w 
// i need to tell minimum number of packs
// so i need to keep patients close(time wise)
// starting form rightmost
// i can go till the patient with time
// rightmost-w and maximum k patient and maximum d time gap between them
