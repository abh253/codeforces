...
// 100->50, 33,25,20,16,14,12,11,10,9,8,7,6,6,6,5,5,5,5,...1
// n root(n);

// because for a number n i can know what were the numbers that make 5 of it and what were the number
// that make 

// how many number makes n to x
// n/x and n/(x+1) +1
// 