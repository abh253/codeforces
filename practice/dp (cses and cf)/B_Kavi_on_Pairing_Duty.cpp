...
void solve(){
    ...
    // vll v(n);vinput(v);
    // state
    // dp[i]=number of ways of pair 2i points
    // base case dp[1]=1;
    // transition->dp[i]=dp[i-1]+number of ways of do same distance with i pairs
    

    // how to find i pairs

    //just find number of factors of i from 1 to i
...
//for current n i have to see the how many possibilities with same length pairs
// then put a pair outside and find same for (n-1) pairs
// sassy dp umma
