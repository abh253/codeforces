...
// in one move i can split 
// in one move i can add two stacks
// if there is a part which is in decreasing order i alway need to split it 
// and will be added to final stack
//x