...
void solve(){
    ll n;cin>>n;
        ...
        cout<<"Ashishgup"<<endl;
            ...
            if(n%2==1){
                // odd*odd*even
                // if odd numbers is greater than 1 ashishgup will win
                // if current n has factors count greater than 1
                // if n is not a prime number than ashishgup wins otherwise
                ll factors=0; 
