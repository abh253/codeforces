...
// for maximum lis
// when we see < we will start placing from 1 and place the numbers in increasing order
// for longest 

// for shortedt

// i want to put the numbers as
// the increasing parts from left to right
// right increasing part should have maximum numbers contributing to their formation
// so that maximum lis would have maximum length same as size of incresing part