...
// starting from 30th bit to 0 bit i need to maximize the element in c 
// if a bit is going to be in f(a,b) then it is important
// otherwise it does no matter what happens to that bit
// important obs- if a bit is not going to be 1 in final

// start from 30 th bit and distribute possible combinations 
// like if this bit could be 1 in f(a,b) then 
// give off ith bit numbers form b which have on bit 
// otherwise


// i was strugling in the implementation which is clear now after editorial