...
// every number in b is equivalet to logn numbers
//
// there is a sequence to it
// first you can take numbers of b and *2 to them and whenever there is a match
// remove it from set a
// after that start with the elemets of b which are left 
// and start /2 all of them if there is a match 