...
//okay this(which i submitted on 19 sep) is wrong because i am not tackling all the cases
//e.g=((( )) ((( )) ( )) 
// 3,2,3,2,1,2
//when starting from 0th index the calculation won't proceed through 1st index
// tried to update 
// still dont understand whats the problem is