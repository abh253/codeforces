...
// obs
// for decreasing part starting from the 0th index
// if i take the minimum of them then that is the max. number by which i can subtract 
// number present after that if i choose to use it number-x then after that i can only subtract number-x for the 
// number present forward and so on  
// this is the idea
