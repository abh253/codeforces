...
// i i do binary search over i*j
// and then 
// i can do binary search on n*m and find a number such that smaller than it is less than k
// how will i avoid getting number that can't be made 
// i by finding largest number which has smaller number less than k