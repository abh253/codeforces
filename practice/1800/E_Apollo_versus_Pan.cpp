...
//taking a number at jth index then
//then taking & with every number and | with every number then multipliying both 
//sets number 
//sum of set(and) * sum of set(or)
//for sum of and set i will check the numbers of element which have bit on same as 
//my jth element and add the numbers*(1<<bit) to the and set
//for sum of or set i will 
//if bit of jth number is on then n*(1<<bit) will be added
//if bit if off then only the numbers*(1<<bit) will be added