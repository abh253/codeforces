...
ll cgood(ll l,ll r,string &s, char c){
    if(l==r){
        if(s[l]==c)return 0;
        else return 1;
    }
    ...
    ll smallans1=mid-l+1-ccountl+cgood(mid+1,r,s,c+1);
    ll smallans2=r-mid-ccountr+cgood(l,mid,s,c+1);
...
// i will either make first half c good or second half c good
