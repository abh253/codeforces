...
// after 2 operations the number would no longer transform 
// take a set put all index
// then keep tract if some index is visited twice 
// remove it from the set
// and use set to traverse the array
// let say l=3,r=8
// then search i(l to r) (index=lower_bound(i) if it lies in the range then change it do the operation
// then i=index
// and complexity= n*logn