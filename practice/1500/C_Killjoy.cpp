...
// i observer there are only there possible outcomes in this question
// 0 if all the elements are equal to x
// otherwise atleast one number is equal to x then 1 or every number can be made x in one contest
// otherwise 2
