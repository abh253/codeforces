...
// if i count number of inversion let say I
// after that in b at position i starting from 0th index ,want to maximise
// number at that position
// so I will just try to put the number starting 