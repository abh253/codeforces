...
//observations:
// if alex have nth card he will always win
// and if boris have n and n-1 th card boris wins
// so remainder cases will be when alex have n-1 card and boris have nth card
// then after first move it will be same like solving for n-2 cards
// and there will be only one combinations which will lead to draw 
