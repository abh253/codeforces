...
void solve(){
    ...
    // IF   i make 2 stacks one and zero whenever
    // in one i keep the subsequence ends with 1 ,i will store its number
    // and similarly for 0
    //when i encounter a zero 
    // i will check in my one stack if it's not empty pop out a one's subs. number
    // and put this subsequence number in zero stack
    // when i encounter one
    // i will do similar think
    //if the stack is empty then new subsequence number will be added
