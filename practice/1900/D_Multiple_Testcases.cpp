...
// i am give size fo arrays of each test case

// and i the number of c array represent  that greater than equal to size i can occur only ci times

// approach :
// start making test cases one by one