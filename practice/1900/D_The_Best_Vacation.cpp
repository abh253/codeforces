...
void solve(){
    ...
    for(int i=2*n-1,j=2*n;i>=n;i--){
        ...
        ll extradays=curdays-x;
        ans=max(ans,cursum-sumkdays(extradays));
...
// by checking every month as last month we can figure out maximum hugs
