...
// as i was observing that we can choose i,j ,k in any order
// observation -
// if there are two numbers same then we can take 3rd number anything and put it at any desired place
// therefore if there are any number with freq[num]>1 answer will always be yes

// i can simulate the answer taking three numbers such that they are not at there place 
// and after rotation one of them reaches to its position
//  or three of them reaches to their required position
// 2 4 3 1 6 5
// 1 2 3 4 6 5