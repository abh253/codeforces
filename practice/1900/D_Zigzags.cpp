...
// prefix sum 
// if i found v[i] and v[j] equal for all numbers , i need number from (i+1 to j-1) and j+1 to n-1
//let say for number loop(k,1,n)
//                      let x =frequency of k from i+1,to j-1
//                      let y=frequency of k from j to n-1
//                       ans+=x*y;
//                         with this approach there will be three loops
//      