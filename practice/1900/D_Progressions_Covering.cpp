...
// many possiblilities
// i don't see any way to discard some possiblities which leads to a greedy approach
// on to the editorial
// ok starting from backward is the way suggest by god of greed.
// 