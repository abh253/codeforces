...
void solve(){
    ...
    cout<<"+ "<<n+1<<endl;
    cout<<"+ "<<n<<endl;
    // this will make a chain structure
    // for instance , n,1,n-1,2,n-2,3,...
    // n and (n+1)/2 are the endpoints
    // if we calculate distance from p1 to every other point the the point with maximum distance is surely one of the end points
    // if we have an endpoint then ,either it's n or (n+1)/2 , so calculate answer for both the possibilities.
