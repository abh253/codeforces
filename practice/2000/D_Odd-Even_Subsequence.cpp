...
// k elements of the array belongs either belongs to odd part or even part
//if i use binary search like let say for a number mid
// for answer to be smaller or equal to mid
// we have to make sure min of max of both even and odd is less than or equal to the mid
// one of the part like even or odd part can go for bigger number so that min still stays less than or equal to mid
